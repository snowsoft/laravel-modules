...
class ModuleGenerator extends Generator
{
    ...
    {
        return with(new Stub('/' . $stub . '.stub', $this->getReplacement($stub)))->render();
    }
    ...
    protected function getReplacement($stub)
    {
        ...
        if (! isset($replacements[$stub]) || ! is_array($replacements[$stub])) {
            return [];
        }
